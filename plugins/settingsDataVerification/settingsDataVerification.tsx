...
type SettingsDataVerificationProps = {
  open?: any
}
...
const SettingsDataVerification: React.FC<SettingsDataVerificationProps> = ({
  open
}: SettingsDataVerificationProps) => {
  const { dialogOpenVerifyContent, setDialogOpenVerifyContent }: any = useModalsAppProvider()
  const classes = useStyles()

  React.useEffect(() => {
    setDialogOpenVerifyContent(open)
  }, [])

  return (
    <Dialog
      open={dialogOpenVerifyContent}
      TransitionComponent={Transition}
      keepMounted
      // fullWidth
      maxWidth="xl"
      onClose={() => {
        setDialogOpenVerifyContent(false)
      }}
...
export default SettingsDataVerification
