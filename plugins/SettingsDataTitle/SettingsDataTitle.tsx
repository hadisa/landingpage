...
const SettingsDataTitle: React.FC<SettingsDataTitleProps> = ({
  open
}: SettingsDataTitleProps) => {
  const { dialogOpenDataTitle, setDialogOpenDataTitle }: any = useModalsAppProvider()
  const classes = useStyles()

  React.useEffect(() => {
    setDialogOpenDataTitle(open)
  }, [])
...
export default SettingsDataTitle
